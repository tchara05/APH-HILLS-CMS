...
public class PropertyForm {
	...
	public static void setPlotID() {
		...
		ResultSet rs;
		try {
			rs = LogIn.database.getStatement().executeQuery(
					"SELECT MAX(plotID)  FROM Property");
	...
	private void initialize() {
		...
		frmPropertyForm.getContentPane()
		...
		panel_3.setBorder(new TitledBorder(new LineBorder(new Color(0, 0, 128),
				3), "Property Details", TitledBorder.LEADING, TitledBorder.TOP,
				null, new Color(0, 0, 0)));

		panel_4 = new JPanel();
		panel_4.setBackground(new Color(255, 255, 255));
<<<<<<< HEAD
		panel_4.setBorder(new TitledBorder(new LineBorder(new Color(0, 0, 128),
				3), "Features", TitledBorder.LEADING, TitledBorder.TOP, null,
				null));
		...
		groupLayout.setHorizontalGroup(groupLayout.createParallelGroup(
				...
				groupLayout
						...
						.addGap(34)
						.addComponent(panel_3, GroupLayout.PREFERRED_SIZE, 580,
								GroupLayout.PREFERRED_SIZE)
						.addGap(18)
						.addComponent(panel_4, GroupLayout.PREFERRED_SIZE, 382,
								GroupLayout.PREFERRED_SIZE)
						.addGap(30)
						.addComponent(panel_2, GroupLayout.PREFERRED_SIZE, 219,
								GroupLayout.PREFERRED_SIZE).addGap(177)));
		groupLayout
...
>>>>>>> parent of 56a92c7... Billing Things
...
<<<<<<< HEAD
		...
		panel.setBounds(329, 65, 206, 240);
		panel.setBackground(new Color(173, 216, 230));
		panel.setBorder(new LineBorder(Color.GRAY));
		JPanel panelDetails = new JPanel();
		panelDetails.setBounds(16, 22, 546, 482);
		...
		txtExtraDetails.setBounds(19, 367, 516, 102);
														...
														gl_panel.createSequentialGroup()
																...
																.addGroup(
																		gl_panel.createParallelGroup(
																				Alignment.LEADING)
																				.addComponent(
																						chckbxRentalGuarantee)
																				.addComponent(
																						chckbxCommited)
																				.addComponent(
																						chckbxRentalPlan)
																				.addComponent(
																						chckbxPropertyDelivered)))
												.addGroup(
														gl_panel.createSequentialGroup()
																.addGap(17)
																.addGroup(
		...
		gl_panel.setVerticalGroup(gl_panel.createParallelGroup(
				...
				gl_panel.createSequentialGroup()
						...
						.addGap(18)
						.addComponent(AllStatus, GroupLayout.PREFERRED_SIZE,
								GroupLayout.DEFAULT_SIZE,
								GroupLayout.PREFERRED_SIZE)
