...
public class PDFexporter {
		...
		private static Font MEDIUMUNDERLINE = new Font (Font.FontFamily.TIMES_ROMAN,16,Font.UNDERLINE);
		...
		private static Font smallerbold = new Font(Font.FontFamily.TIMES_ROMAN,8,Font.BOLD);
...
private void BankInfo(int type , Document doc) throws Exception{
	...
	public static void main(String args[]) throws Exception{
		...
		PdfWriter.getInstance(doc, new FileOutputStream("home.test.pdf"));
		doc.open();
