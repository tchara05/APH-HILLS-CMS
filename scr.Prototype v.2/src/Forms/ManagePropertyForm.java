...
import Threads.BtnEditProperty;


public class ManagePropertyForm {
	...
	public static void main(String[] args) {
		...
		ManagePropertyForm  viewMane= new ManagePropertyForm();
	}
	...
	public static void callRepaint() {
		ManagePropertyForm.ManagePropFrame.revalidate();
		ManagePropertyForm.ManagePropFrame.repaint();
	}
